//please contact me noithatasahome@gmail.com@gmail.com
//website http://asagroup.vn or http://asahome.vn
(function(JQuery) {
...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='https://goo.gl/fZBTzc' target='_blank'><img src='http://asahome.vn/wp-content/uploads/2017/08/thiet-ke-can-ho-chung-cu.jpg' width='500px'/><br/>THIẾT KẾ THI CÔNG NỘI THẤT SHOP - CĂN HỘ... TẠI TP.HCM</a>. CÔNG TY CỔ PHẦN ASA GROUP. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
